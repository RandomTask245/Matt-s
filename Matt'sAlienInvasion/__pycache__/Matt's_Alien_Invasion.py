...
#Initialize the game, and create game resources
        ...
        pygame.display.set_caption ("Matthew's Awesome Alien Invasion")    
        ...
        # ^Trying to get background to look like space vibes
...
# Watch for keyboard and mouse events
    def _update_screen(self):
        self.screen.fill(self.bg_color) 
            #^Invoke background color with each iteration
        self.ship.blitme()
